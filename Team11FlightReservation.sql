...
CREATE SCHEMA `FlightReservation` DEFAULT CHARACTER SET utf8 ;
...
CREATE TABLE `Reservation` (
  ...
  CONSTRAINT `fk_passenger_id`  FOREIGN KEY (`passenger_id`) REFERENCES `Passenger` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
